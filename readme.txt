...
1. Add in a delete user link (have to sort out the nonce stuff for that, and if there was a delete option from a users wp profile, I'd be done).
2. Maybe make the 25 recent users a selectable list. 5, 10 or 25.

== Frequently Asked Questions ==

= Will this work on older versions of WordPress? =

Probably, but I only have v 2.7.1.  Just at a glance, it should work on any 2.x WP at this point.
